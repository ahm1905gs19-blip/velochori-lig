...
# --- 1. SAYFA VE GENEL TASARIM (SENİN TASARIMIN) ---
...
.digital-scoreboard { background: #273142; color: #00ff85; font-family: 'JetBrains Mono', monospace; font-size: 1rem; padding: 4px 12px; border-radius: 8px; min-width: 80px; text-align: center; border: 1px solid #334155; margin: 0 40px; }
...
# --- 2. VERİ VE ÖLÇÜM MANTIĞI (GÜNCELLENDİ) ---
# 11. Hafta skoru 16-15 olarak hafızaya alınıyor
...
with st.sidebar:
    ...
    with st.form("admin_form"):
        h = st.number_input("Hafta", 11, 20, 12) # 11 dolu olduğu için 12'den başlatır
...
with tab2:
    ...
    for i in range(10):
        ...
        <div class="stadium-card">
            ...
            <div style="background:#f8fafc; padding:8px; text-align:center; font-size:10px; font-weight:800;">{status}</div>
        </div>
        """, unsafe_allow_html=True)
