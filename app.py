...
# (Tab 1 ve Tab 3 içerikleri aynı kalıyor...)
...
with tab2:
    ...
    for i in range(10):
        ...
        is_today = m_dt == today
        is_live = is_today and now >= match_time # Bugün ve saat 19:30 sonrası mı?
        ...
        if res:
            ...
            status_text = '<span class="live-anim">⚽ OYNANIYOR...</span>'
            status_color, status_bg = '#ef4444', '#fee2e2'
            score_display = '<div class="vs-text">VS</div>'
        elif is_today:
            status_text = '🔥 MAÇ GÜNÜ'
            status_color, status_bg = '#059669', '#ecfdf5'
            score_display = '<div class="vs-text">VS</div>'
        else:
            status_text = '○ BEKLİYOR'
            status_color, status_bg = '#64748b', '#f1f5f9'
            score_display = '<div class="vs-text">VS</div>'
